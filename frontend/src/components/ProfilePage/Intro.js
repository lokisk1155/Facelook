...
function Intro({ currentUser, sessionUser }) {
    ...
    return (
        <div className="intro-container">
            ...
            <div style={{ borderBottom: "1px solid lightgrey", margin: "10px"}}></div>
            {isUser && toggleBio ? <><button style={{ justifyContent: "center"}} onClick={(() => setToggleBio(true))}>Edit Bio</button>
