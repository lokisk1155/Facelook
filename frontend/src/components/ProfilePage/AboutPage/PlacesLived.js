...
import { setCurrentProfile, updateUser, updateUserArray } from "../../../store/user"
...
function PlacesLived({ currentUser }) {
    ...
    return (
        ...
        <div>
            ...
            <div>
                {toggleAddCity && <form onSubmit={handleAddCity}>
                    <input type='text' onChange={(e) => setFakeCity(e.target.value)}placeholder="City"></input>
