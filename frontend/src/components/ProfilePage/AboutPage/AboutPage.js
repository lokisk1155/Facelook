    ...
    <div className="about-page-container">
      <div className="about-page-block">
        ...
        <div className="about-page-component-selector">
          ...
          {placesLived && (
            <PlacesLived currentUser={currentUser} isUser={isUser} />
          )}
          {workEd && <WorkEd currentUser={currentUser} isUser={isUser} />}
          {relationship && (
            <Relationship currentUser={currentUser} isUser={isUser} />
          )}
          {contactInfo && (
            <ContactInfo currentUser={currentUser} isUser={isUser} />
          )}
        </div>
      </div>
    </div>
