...
function ProfileDefault({ componentName, about }) {
    ...
    const friendIds = useSelector((state) => Object.values(state.user[id].friends));
    ...
    console.log(componentName, 'component name lol')
    ...
    function checkFriendCrednetials() {
        ...
        setCurrentUserName(`${capitalizeFirstLetter(currentUser.first_name)} ${capitalizeFirstLetter(currentUser.last_name)}`)
    ...
    return (
        <>
            <ProfileTop sessionUser={sessionUser} currentUser={currentUser} isFriend={isFriend} friendCount={friendCount} notSelf={notSelf} currentUserName={currentUserName} setIsFriend={setIsFriend} />
            {componentName === "Posts" ? <Posts sessionUser={sessionUser} currentUser={currentUser} friends={friends}/> : null}
            {componentName === "Friends" ? <Friends sessionUser={sessionUser} currentUser={currentUser} friends={friends} divHeight={divHeight} /> : null}
            {componentName === "About" ?     <div className="about-page-container">
